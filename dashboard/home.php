      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <script type="text/javascript">
            ...
            $(document).ready(function () {
              ...
              setInterval(function () {
                requestDatta(sessiondata, router());
              }, 1000);
          ...
          <?php
               ...
               //         $valor=array($getinterfacetraffic); 
                      // if($API->connect( $iphost, $userhost, decrypt($passwdhost))){

                      //   //$getinterface = $API->comm("/interface/print");
                      //       //$interface = $getinterface[$iface-1]['name'];
                      //        $getinterfacetraffic = $API->comm("/tool/torch", array(
                      //                "interface" => "ether1"));
                      //       //         $valor=array($getinterfacetraffic); 
                      //              echo($getinterfacetraffic);
                      //       // $getinterfacetraffic = $API->comm("/tool/torch", array(
                      //       //   "interface" => "$interface"    
                      //       //   ));
                      ...
                      //     //   $ftx = $getinterfacetraffic[0]['TX'];
                      //     //   $frx = $getinterfacetraffic[0]['RX'];
                      ...
                      //$TotalReg = count($getinterfacetraffic);
